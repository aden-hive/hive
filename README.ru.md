...
- [Docker](https://docs.docker.com/get-docker/) (v20.10+) - Необязательно. Требуется только при использовании MCP-инструментов, которым необходимы контейнеризованные зависимости (например, PostgreSQL, Redis). Для базовой разработки агентoв не требуется.

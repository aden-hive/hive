...
# Goal definition
goal = Goal(
    id="simple-tech-research",
    name="Simple Tech Research Agent",
    description=(
    "Research a technology or AI topic from multiple sources, analyze the findings, "
    "and produce a short structured summary explaining key ideas, tools, and trends."
    ),
    success_criteria=[
        SuccessCriterion(
            id="source-diversity",

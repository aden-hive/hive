...
Note: Free tier includes 1,000 searches/month.""",
    ...
    "duckduckgo": CredentialSpec(
        env_var="N/A",
        tools=["ddg_search_web", "ddg_search_news"],
        node_types=[],
        required=False,
        startup_required=False,
        help_url="https://duckduckgo.com",
        description="Anonymous web search",
        direct_api_key_supported=False,
        api_key_instructions="No API key required for DuckDuckGo. Searches are anonymous.",
        health_check_endpoint="https://duckduckgo.com",
        health_check_method="GET",
        credential_id="duckduckgo",
        credential_key="N/A",
    ),
}

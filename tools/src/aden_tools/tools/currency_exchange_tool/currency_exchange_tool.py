...
def register_tools(
    ...
    Authentication is handled via the EXCHANGERATE_API_KEY environment variable.
    Get a free key at https://exchangerate-api.com (1,500 requests/month, no card needed).
    ...
    def currency_exchange_get_rates(base_currency: str) -> dict:
        ...
        Returns:
            Dict with base_currency, last_updated timestamp, and rates mapping.
    ...
    def currency_exchange_convert(
        ...
        Returns:
            Dict with from_currency, to_currency, original_amount, converted_amount,
            exchange_rate, and last_updated. Or error dict if request fails.
    ...
    def currency_exchange_list_currencies() -> dict:
        ...
        Returns:
            Dict with count and currencies list (each with 'code' and 'name').
            Or error dict if request fails.
        ...
        try:
            ...
            currencies = [{"code": code, "name": name} for code, name in supported]
            return {
                "success": True,

...
2. **Secure Configuration**: Review `~/.hive/configuration.json` and environment variable settings, especially in production
3. **Environment Variables**: Never commit `.env` files or configuration files containing secrets

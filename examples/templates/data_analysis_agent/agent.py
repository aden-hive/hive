...
# Goal definition
goal: Goal = Goal(
    id="data-analysis-goal",
    name="Data Analysis",
    description=(
        "Analyze datasets to generate structured insights including "
        "summary statistics, patterns, and trends. "
    ),
    success_criteria=[
        SuccessCriterion(
            id="sc-data-loaded",
            description="Dataset successfully loaded and processed",
            metric="dataset_loaded",
            target="true",
            weight=0.25,
        ),
        SuccessCriterion(
            id="sc-summary-generated",
            description="Summary statistics generated",
            metric="summary_statistics",
            target="true",
            weight=0.25,
        ),
        SuccessCriterion(
            id="sc-patterns-detected",
            description="Patterns or trends identified in the dataset",
            metric="patterns_detected",
            target="true",
            weight=0.25,
        ),
        SuccessCriterion(
            id="sc-report-generated",
            description="User receives a structured analysis report",
            metric="analysis_report",
            target="true",
            weight=0.25,
        ),
    ],
    constraints=[
        Constraint(
            id="c-no-fabrication",
            description="Never fabricate insights or results",
            constraint_type="hard",
            category="quality",
        ),
        Constraint(
            id="c-data-integrity",
            description="Ensure analysis is based only on the provided dataset",
            constraint_type="hard",
            category="quality",
        ),
    ],
...
class DataAnalysisAgent:
    """
    Data Analysis Agent — automated dataset analysis workflow.
...
default_agent: DataAnalysisAgent = DataAnalysisAgent()

...
class TestLLMRoutingFailureModes:
    ...
    async def test_backward_compatibility_default_is_proceed(self):
    ...
    async def test_llm_failure_mode_proceed_on_missing_llm(self):
    ...
    async def test_llm_failure_mode_proceed_on_exception(self):
        """Test PROCEED mode when LLM throws exception - should return source_success."""
        edge = self.create_edge(on_llm_failure=LLMFailureMode.PROCEED)

        # Mock LLM that raises exception
        mock_llm = AsyncMock()
        mock_llm.acomplete.side_effect = Exception("LLM API error")
    ...
    async def test_llm_failure_mode_proceed_on_parse_error(self):
    ...
    async def test_llm_failure_mode_skip_on_missing_llm(self):
    ...
    async def test_llm_failure_mode_skip_on_exception(self):
    ...
    async def test_llm_failure_mode_skip_on_parse_error(self):
    ...
    async def test_llm_failure_mode_raise_on_missing_llm(self):
    ...
    async def test_llm_failure_mode_raise_on_exception(self):
    ...
    async def test_llm_failure_mode_raise_includes_context(self):
    ...
    async def test_llm_routing_success_ignores_failure_mode(self):
    ...
    async def test_llm_routing_success_can_skip(self):
    ...
    async def test_security_critical_edge_fail_closed(self):
        """
        ...
        result = await auth_edge.should_traverse(
    ...
    async def test_missing_goal_handled_correctly(self):
...
class TestLLMRoutingErrorMessages:
    ...
    async def test_error_message_includes_edge_id(self, caplog):
    ...
    async def test_raise_mode_exception_chains_original_error(self):
        ...
        mock_llm.acomplete.side_effect = original_error

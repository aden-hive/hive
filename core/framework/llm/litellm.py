...
def _dump_failed_request(
    ...
    try:
        ...
        #this prevent logging failures from crashing the main execution thread
        #in read only( -r ) environments (like Docker, AWS lambda, Cloud run... etc etc)
        # or open () may fail. we log the error server side and continue

...
Contains the abstract NodeProtocol that all nodes must implement,
plus concrete implementations: LLMNode, RouterNode, FunctionNode.
"""
...
"""
    ...
    def _extract_json(
        ...
        try:
            ...
            try:
                fixed = fix_unescaped_newlines_in_json(content)
                ...
                try:
                    ...
                    if extracted:  # Skip empty matches
                        ...
                        try:
                            ...
                            parsed = json.loads(fix_unescaped_newlines_in_json(extracted))
                        if isinstance(parsed, dict):
                            return parsed
                except json.JSONDecodeError:
                    pass
        ...
        if json_str:
            try:
                ...
                try:
                    ...
                    parsed = json.loads(fix_unescaped_newlines_in_json(json_str))
                if isinstance(parsed, dict):
                    return parsed
            except json.JSONDecodeError:
                pass
...
Do NOT fabricate data or return empty objects."""
        ...
        try:
            ...
            try:
                ...
                parsed = json.loads(fix_unescaped_newlines_in_json(cleaned))
...
__all__ = ["NodeProtocol", "LLMNode", "RouterNode", "FunctionNode"]

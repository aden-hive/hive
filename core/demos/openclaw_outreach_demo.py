#!/usr/bin/env python3
"""
OpenClaw Outreach Pipeline Demo

Demonstrates the full GraphExecutor framework for automating outreach
to OpenClaw stargazers.
...
def load_campaign_template() -> dict:
    ...
    return {
        "template": (
            "Subject: Quick question about your interest in OpenClaw\n\n"
            "Hi {name},\n\n"
            "I noticed that you starred OpenClaw on GitHub! 🦞\n\n"
            "We're currently reaching out to our community to see how we can make "
            "OpenClaw even more useful. I saw your work on {user_repo_highlights} "
            "and thought you might have some interesting perspectives.\n\n"
            "Would you be open to a quick 5-minute chat, or perhaps you could "
            "share what specific features brought you to OpenClaw?\n\n"
            "Best,\nThe OpenClaw Team"
        ),
    }
...
NODE_SPECS = {
    "intake": NodeSpec(
        ...
        system_prompt=(
            ...
            "(e.g., https://github.com/openclaw/openclaw)\n"

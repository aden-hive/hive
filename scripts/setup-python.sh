...
echo "  PYTHONPATH=core python -m agent_name validate"
echo "  PYTHONPATH=core python -m agent_name info"
echo "  PYTHONPATH=core python -m agent_name run --input '{...}'"
echo ""
echo "Available commands for your new agent:"
echo "  PYTHONPATH=core python -m support_ticket_agent validate"
echo "  PYTHONPATH=core python -m support_ticket_agent info"
echo "  PYTHONPATH=core python -m support_ticket_agent run --input '{\"ticket_content\":\"...\",\"customer_id\":\"...\",\"ticket_id\":\"...\"}'"
echo ""
...
echo "Agent Examples: ${PROJECT_ROOT}/"
echo ""

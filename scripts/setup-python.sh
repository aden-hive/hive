...
echo ""
echo "  ${BLUE}# From project root (Unix/Linux/Mac):${NC}"
...
echo ""
echo "  ${BLUE}# Windows PowerShell:${NC}"
echo "  \$env:PYTHONPATH=\"core;exports\"; python -m agent_name validate"
echo "  \$env:PYTHONPATH=\"core;exports\"; python -m agent_name info"
echo "  \$env:PYTHONPATH=\"core;exports\"; python -m agent_name run --input '{...}'"
echo ""
echo "Available commands for your new agent:"
echo "  ${BLUE}# Unix/Linux/Mac:${NC}"
...
echo ""
echo "  ${BLUE}# Windows PowerShell:${NC}"
echo "  \$env:PYTHONPATH=\"core;exports\"; python -m support_ticket_agent validate"
echo "  \$env:PYTHONPATH=\"core;exports\"; python -m support_ticket_agent info"
echo "  \$env:PYTHONPATH=\"core;exports\"; python -m support_ticket_agent run --input '{\"ticket_content\":\"...\",\"customer_id\":\"...\",\"ticket_id\":\"...\"}'"
echo ""

...
Note: `exports/` is user-generated (agents are created by `/building-agents` or added manually) and is not tracked in the repo.
...
2. Follow the standard agent structure (generated by `/building-agents`)

...
### Hive 帮助团队构建具有弹性、能够在生产环境中自适应并持续改进的 AI 智能体系统。
...
Hive 专为想要构建**生产级 AI 智能体**而无需手动编写复杂工作流的开发者和团队设计。

| 特性 | Hive 的最佳应用场景 | 不适合 Hive 的场景 |
| :--- | :--- | :--- |
| **复杂度** | 真实的业务流程、复杂的多智能体工作流 | 简单的智能体链或一次性脚本 |
| **生命周期** | 具有自愈能力的长期运行、自主智能体 | 临时或非自主的实验 |
| **可靠性** | 需要防护栏和成本限制的生产环境 | 没有风险约束的纯实验室演示 |
| **方法论** | 随时间改进的目标驱动开发 | 硬编码、静态工作流 |
| **人类控制** | 明确的人机协作和可观察性需求 | 完全黑暗/未观察的执行 |

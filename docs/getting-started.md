...
### Option 2: From an Existing Agent Package

```bash
# If you already have an agent package (generated by /building-agents or shared by a teammate),
# place it under exports/ and copy it to start customizing.
mkdir -p exports
cp -r exports/your_agent exports/my_agent

...
You (Antigravity) write the tests directly using the Write tool based on the guidelines.
...
**Key Principle: MCP tools provide guidelines, Antigravity writes tests directly**
...
- Antigravity writes tests directly, eliminating circular LLM dependencies in the MCP server

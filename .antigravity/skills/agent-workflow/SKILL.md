...
- **building-agents-core**: See `.antigravity/skills/building-agents-core/SKILL.md`
- **building-agents-construction**: See `.antigravity/skills/building-agents-construction/SKILL.md`
- **building-agents-patterns**: See `.antigravity/skills/building-agents-patterns/SKILL.md`
- **testing-agent**: See `.antigravity/skills/testing-agent/SKILL.md`
